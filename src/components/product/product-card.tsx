...
function ProductCard({product}: {product?: IProduct}) {
    return (
        <div className='w-full h-full max-w-[412px] max-h-[446px] lg:max-h-[683px] bg-[#FAFAFA] p-4 lg:py-6 px-4 space-y-6'>
            ...
            <div className='space-y-5 w-[232px] lg:w-[390px]'>
                <h4 className='text-xl lg:text-2xl'>{product ? product.name : "Mother and Child Lotion"}</h4>
                <p className='font-semibold text-xl lg:text-2xl'>{product ? product.price : "$10.12"}</p>
            </div>
        </div>
    )
}
